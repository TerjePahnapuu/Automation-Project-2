describe("Issue comments creating, editing and deleting", () => {
  ...
  it("Should edit a comment successfully", () => {
    ...
    getIssueDetailsModal().within(() => {
      ...
      cy.get('[data-testid="issue-comment"]').should("contain", "Edit").and("contain", comment);
    });
  });
...
describe("Issue comments creating, editing and deleting", () => {
  ...
  it("Should edit a comment successfully", () => {
    const comment = "Editing the testing";
    ...
    getIssueDetailsModal().within(() => {
      ...
      cy.get('textarea[placeholder="Add a comment..."]').clear().type(comment);
